...
public class UrlNormalizer {
    ...
    public static String normalize(String targetUrl, String baseUrl) {
    	System.out.println("Normalizing url: " + targetUrl + " (base form): " + baseUrl);
        ...
        if(targetUrl.isEmpty())	return baseUrl;
...
//        }
        ...
        if(!returnString.isEmpty() && !returnString.startsWith("http"))
        	returnString = "http://" + returnString;
        
        System.out.println("Normalized URL: " + builder.toString());
